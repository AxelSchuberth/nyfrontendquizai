...
const UI_TEXT = {
  en: {
    ...
    uploadFilesBody: "Add lecture slides, summaries or notes. PDF and TXT files work best.",
  ...
  sv: {
    ...
    uploadFilesBody: "Lägg till föreläsningsbilder, sammanfattningar eller anteckningar. PDF- och TXT-filer fungerar bäst.",
...
function formatDate(date, appLanguage = "en", t = UI_TEXT.en) {
